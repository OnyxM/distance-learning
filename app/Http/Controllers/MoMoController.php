...
//         echo $momo->disTransfer("100","237678955362","transaction_id");
...
////        this is to check if the number has a mobile money account
        ...
        dd($momo->colRequestToPay("200","237678955362","transaction_id"));
        echo $momo->colStatus("1c2d671d-d00d-43a9-92ea-25ea8aab9cb1");
        echo $momo->colCheckBalance();
        echo $momo->colCheckAccountHolder("237678955362"); //21592
    }
}
